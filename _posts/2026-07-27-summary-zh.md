...
rss · Cointelegraph · 7月27日 09:01

**背景**: Storj 是一个去中心化云存储平台，利用区块链技术让用户出租未使用的硬盘空间。STORJ 代币用于支付存储服务并奖励节点运营商。申请第 11 章破产并不一定意味着清算；它是一种重组过程，公司常用于管理债务同时继续运营。
...
hackernews · eecc · 7月27日 06:21 · [社区讨论](https://news.ycombinator.com/item?id=49063022)

**背景**: GrapheneOS 是一款注重安全的基于 Android 的操作系统，包含胁迫 PIN 码等功能以保护用户数据。胁迫 PIN 码是一个单独的密码，输入时会触发数据删除而非解锁设备。美国边境当局拥有广泛的搜查权，个人通常需要配合设备检查。此事件凸显了在边境使用反取证工具的法律风险。
